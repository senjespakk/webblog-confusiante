...
class Contact extends Component {
    ...
    handleSubmit(values) {
        this.props.postFeedback(values.firstname, values.lastname, values.telnum, values.agree, values.contackType, values.message);
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors 
                                        ...
                                        messages={{
                                            required: 'required',
                                            minLength: 'Must be a valid phone',
                                            maxLength: 'Must be a valid phone',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors 
                                        ...
                                        messages={{
                                            required: 'required',
                                            validEmail: 'looks like an invalid email'
                                        }}
                                    /> 
                                </Col>
                            </Row>
